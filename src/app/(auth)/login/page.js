        ...
        <div className="min-h-screen flex items-center justify-center">
            <div className="max-w-xl mx-auto p-4 space-y-4 border">
                <form onSubmit={handleSignIn}>
                    ...
                    <button className='cursor-pointer bg-blue-500 text-white p-2 rounded w-full mt-2' type="submit">Login</button>
                </form>
                <div>
                    <button className='cursor-pointer bg-red-500 text-white p-2 rounded w-full mt-2'>Google</button>
                    <p className='text-center text-sm text-gray-500 mt-2'>Dont have an account? <Link href="/register" className='text-blue-500 hover:underline'>Sign up</Link></p>
                </div>
            </div>
        </div>
    );
